...
function _redeploy(resourceGroupName, vmScaleSetName, options, callback) {
  ...
  // Send request
  this.beginRedeploy(resourceGroupName, vmScaleSetName, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _performMaintenance(resourceGroupName, vmScaleSetName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginPerformMaintenance(resourceGroupName, vmScaleSetName, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _forceRecoveryServiceFabricPlatformUpdateDomainWalk(resourceGroupName, vmScaleSetName, platformUpdateDomain, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  try {
    ...
    if (platformUpdateDomain === null || platformUpdateDomain === undefined || typeof platformUpdateDomain !== 'number') {
      throw new Error('platformUpdateDomain cannot be null or undefined and it must be of type number.');
    }
    if (this.client.acceptLanguage !== null && this.client.acceptLanguage !== undefined && typeof this.client.acceptLanguage.valueOf() !== 'string') {
      throw new Error('this.client.acceptLanguage must be of type string.');
    }
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/forceRecoveryServiceFabricPlatformUpdateDomainWalk';
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{vmScaleSetName}', encodeURIComponent(vmScaleSetName));
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  let queryParameters = [];
  queryParameters.push('api-version=' + encodeURIComponent(apiVersion));
  queryParameters.push('platformUpdateDomain=' + encodeURIComponent(platformUpdateDomain.toString()));
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
  }
  ...
  return client.pipeline(httpRequest, (err, response, responseBody) => {
    ...
    if (statusCode === 200) {
      ...
      try {
        ...
        result = JSON.parse(responseBody);
        if (parsedResponse !== null && parsedResponse !== undefined) {
          let resultMapper = new client.models['RecoveryWalkResponse']().mapper();
          result = client.deserialize(resultMapper, parsedResponse, 'result');
        }
      } catch (error) {
        let deserializationError = new Error(`Error ${error} occurred in deserializing the responseBody - ${responseBody}`);
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _beginRedeploy(resourceGroupName, vmScaleSetName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/redeploy';
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{vmScaleSetName}', encodeURIComponent(vmScaleSetName));
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  let queryParameters = [];
 ...
 *                      {stream} [response] - The HTTP Response stream if an error did not occur.
 */
function _beginPerformMaintenance(resourceGroupName, vmScaleSetName, options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Compute/virtualMachineScaleSets/{vmScaleSetName}/performMaintenance';
  requestUrl = requestUrl.replace('{resourceGroupName}', encodeURIComponent(resourceGroupName));
  requestUrl = requestUrl.replace('{vmScaleSetName}', encodeURIComponent(vmScaleSetName));
  requestUrl = requestUrl.replace('{subscriptionId}', encodeURIComponent(this.client.subscriptionId));
  let queryParameters = [];
...
class VirtualMachineScaleSets {
  ...
  constructor(client) {
    ...
    this._forceRecoveryServiceFabricPlatformUpdateDomainWalk = _forceRecoveryServiceFabricPlatformUpdateDomainWalk;
  ...
  redeployWithHttpOperationResponse(resourceGroupName, vmScaleSetName, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._redeploy(resourceGroupName, vmScaleSetName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  redeploy(resourceGroupName, vmScaleSetName, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._redeploy(resourceGroupName, vmScaleSetName, options, optionalCallback);
    }
  }
  ...
  performMaintenanceWithHttpOperationResponse(resourceGroupName, vmScaleSetName, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._performMaintenance(resourceGroupName, vmScaleSetName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  performMaintenance(resourceGroupName, vmScaleSetName, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._performMaintenance(resourceGroupName, vmScaleSetName, options, optionalCallback);
    }
  }
  ...
  forceRecoveryServiceFabricPlatformUpdateDomainWalkWithHttpOperationResponse(resourceGroupName, vmScaleSetName, platformUpdateDomain, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._forceRecoveryServiceFabricPlatformUpdateDomainWalk(resourceGroupName, vmScaleSetName, platformUpdateDomain, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  forceRecoveryServiceFabricPlatformUpdateDomainWalk(resourceGroupName, vmScaleSetName, platformUpdateDomain, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._forceRecoveryServiceFabricPlatformUpdateDomainWalk(resourceGroupName, vmScaleSetName, platformUpdateDomain, options, optionalCallback);
    }
  }
  ...
  beginRedeployWithHttpOperationResponse(resourceGroupName, vmScaleSetName, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginRedeploy(resourceGroupName, vmScaleSetName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  beginRedeploy(resourceGroupName, vmScaleSetName, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._beginRedeploy(resourceGroupName, vmScaleSetName, options, optionalCallback);
    }
  }
  ...
  beginPerformMaintenanceWithHttpOperationResponse(resourceGroupName, vmScaleSetName, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginPerformMaintenance(resourceGroupName, vmScaleSetName, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  beginPerformMaintenance(resourceGroupName, vmScaleSetName, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._beginPerformMaintenance(resourceGroupName, vmScaleSetName, options, optionalCallback);
    }
  }
